...
pub fn main() !void {
    ...
    effect_names[0] = "/BasicDemo/validate";
    effect_names[1] = "/BasicDemo/process";
    ...
    complete_trans.guard = "/BasicDemo/guard";
    ...
    idle_entry_names[0] = "/BasicDemo/idle/entry";
